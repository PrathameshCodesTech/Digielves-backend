...
def sendBusinessCard(mail, card, full_name):
    try:
        user_folder = settings.MEDIA_ROOT

        with open(f'{user_folder}/email_templates/send_business_card.html', 'r') as template_file:
            template_content = template_file.read()

        # Get image data from the InMemoryUploadedFile object
